...
<body>
    <header>
      ...
      <div class="menuList">
        <ul>
          <li><img src="../img/login.jpg" alt="ログインロゴ"><a href="./login.php">ログイン</a></li>
          <li><img src="../img/acount.png" alt="アカウントロゴ"><a href="./list.php">アカウント情報変更</a></li>
          <li class="admin-menu"><img src="../img/list.jpg" alt="ロゴ"><a href="./manager.php">ほしいものリスト</a></li>
          <li class="admin-menu"><img src="../img/home.png" alt="メインロゴ"><a href="./manager.php">貯金金額画面</a></li>
          <li class="admin-menu"><img src="../img/shift.jpeg" alt="シフトロゴ"><a href="./correction.php">シフトボード</a></li>
          <li class="admin-menu"><a href="./anketto.php">貯まる君について</a></li>
          <li class="admin-menu"><a href="./feedback.php">評価について</a></li>
          <li><img src="../img/logout.jpg" alt="ログアウトロゴ"><a href="./login.php" id="logout">ログアウト</a></li>
        </ul>
      </div>
    </div>
    </header>
